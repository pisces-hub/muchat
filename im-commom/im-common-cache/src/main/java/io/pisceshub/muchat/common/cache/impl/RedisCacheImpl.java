package io.pisceshub.muchat.common.cache.impl;
...
public class RedisCacheImpl implements AppCache {
    ...
    /**
     * 使用Sorted Set记录keyword zincrby命令，对于一个Sorted
     * Set，存在的就把分数加x(x可自行设定)，不存在就创建一个分数为1的成员
     *
    ...
    /**
     * zrevrange命令, 查询Sorted Set中指定范围的值 返回的有序集合中，score大的在前面
